                  ...
                  <ul className="text-slate-700 dark:text-slate-100">
                    <li className="mt-1 mb-5">
                      ...
                      <div className="flex items-center my-1">
                          <input onClick={() => dispatch({ type: "SORT_BY", payload : { sortBy: "LToH"}})} id="price-sort-1" type="radio" checked={state.sortBy === "LToH"} value="" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                          <label htmlFor="price-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Price - Low to High</label>
                      </div>
                      <div className="flex items-center my-1">
                          <input onClick={() => dispatch({ type: "SORT_BY", payload : { sortBy: "HToL"}})} id="price-sort-2" type="radio" checked={state.sortBy === "HToL"} value="" name="price-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                    ...
                    <li className="mt-1 mb-5">
                      ...
                      <div className="flex items-center my-1">
                          <input onClick={() => dispatch({ type: "RATINGS", payload : { rating: "4AndA"}})} id="rating-sort-1" type="radio" checked={state.rating === "4AndA"} value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                          <label htmlFor="rating-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">4 Stars & Above</label>
                      </div>
                      <div className="flex items-center my-1">
                          <input onClick={() => dispatch({ type: "RATINGS", payload : { rating: "3AndA"}})} id="rating-sort-2" type="radio" checked={state.rating === "3AndA"} value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                          <label htmlFor="rating-sort-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">3 Stars & Above</label>
                      </div>
                      <div className="flex items-center my-1">
                          <input onClick={() => dispatch({ type: "RATINGS", payload : { rating: "2AndA"}})} id="rating-sort-3" type="radio" checked={state.rating === "2AndA"} value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                          <label htmlFor="rating-sort-3" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">2 Stars & Above</label>
                      </div>
                      <div className="flex items-center my-1">
                          <input onClick={() => dispatch({ type: "RATINGS", payload : { rating: "1AndA"}})} id="rating-sort-4" type="radio" checked={state.rating === "1AndA"} value="" name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                    ...
                    <li className="mt-1 mb-5">
                      ...
                      <div className="flex items-center my-1">
                          <input onClick={() => dispatch({ type: "BEST_SELLER_ONLY", payload : { bestSellerOnly: !state.bestSellerOnly}})} id="best-seller" checked={state.bestSellerOnly} type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                          <label htmlFor="best-seller" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Best Seller Only</label>
                      </div>
                      <div className="flex items-center my-1">
                          <input onClick={() => dispatch({ type: "ONLY_IN_STOCK", payload : { onlyInStock: !state.onlyInStock}})} id="only-instock" checked={state.onlyInStock} type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
